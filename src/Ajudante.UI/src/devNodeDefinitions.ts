...
export function getDevNodeDefinitions(): NodeDefinition[] {
  ...
  const selectorProps = (defaultControlType = ''): NodeDefinition['properties'] => [
    ...
    { id: 'elementNameMatch', name: 'Element Name Match', type: 'Dropdown', defaultValue: 'equals', options: ['equals', 'contains', 'regex'] },
    ...
    { id: 'fallbackAnchorAutomationId', name: 'Fallback Anchor Automation ID', type: 'String', defaultValue: '' },
    { id: 'fallbackAnchorElementName', name: 'Fallback Anchor Element Name', type: 'String', defaultValue: '' },
    { id: 'fallbackAnchorElementNameMatch', name: 'Fallback Anchor Name Match', type: 'Dropdown', defaultValue: 'equals', options: ['equals', 'contains', 'regex'] },
    { id: 'fallbackAnchorControlType', name: 'Fallback Anchor Control Type', type: 'String', defaultValue: '' },
    { id: 'fallbackAnchorOffsetX', name: 'Fallback Anchor Offset X', type: 'Integer', defaultValue: 0 },
    { id: 'fallbackAnchorOffsetY', name: 'Fallback Anchor Offset Y', type: 'Integer', defaultValue: 0 },
  ];
  ...
  return [
    ...
    define('logic.chatMenuRouter', 'Chat Menu Router', 'Logic', 'Routes numbered chat menu replies into safe automation intents', [
      { id: 'message', name: 'Message', type: 'String', defaultValue: '{{lastChatMessage}}' },
      { id: 'allowedCommands', name: 'Allowed Commands', type: 'String', defaultValue: 'ipconfig,whoami,hostname,systeminfo,ver' },
      { id: 'flowMenuStartNumber', name: 'Flow Menu Start Number', type: 'Integer', defaultValue: 10 },
      { id: 'flowCatalogJson', name: 'Flow Catalog JSON', type: 'String', defaultValue: '{{runnableFlowsCatalog}}' },
      { id: 'storeIntentInVariable', name: 'Store Intent In Variable', type: 'String', defaultValue: 'chatIntent' },
      { id: 'storeCommandInVariable', name: 'Store Command In Variable', type: 'String', defaultValue: 'requestedCommand' },
      { id: 'storeFlowIdInVariable', name: 'Store Flow ID In Variable', type: 'String', defaultValue: 'requestedFlowId' },
      { id: 'storeReasonInVariable', name: 'Store Reason In Variable', type: 'String', defaultValue: 'chatRouteReason' },
    ], [
      { id: 'screenshot', name: 'Screenshot', dataType: 'Flow' },
      { id: 'command', name: 'Command', dataType: 'Flow' },
      { id: 'systemInfo', name: 'System Info', dataType: 'Flow' },
      { id: 'listFlows', name: 'List Flows', dataType: 'Flow' },
      { id: 'runFlow', name: 'Run Flow', dataType: 'Flow' },
      { id: 'stop', name: 'Stop', dataType: 'Flow' },
      { id: 'unknown', name: 'Unknown', dataType: 'Flow' },
      { id: 'intent', name: 'Intent', dataType: 'String' },
      { id: 'commandText', name: 'Command', dataType: 'String' },
      { id: 'flowId', name: 'Flow ID', dataType: 'String' },
      { id: 'reason', name: 'Reason', dataType: 'String' },
    ]),
    ...
    define('action.browserClick', 'Browser Click', 'Action', 'Clicks a browser element found by locator', [
      ...selectorProps(),
      { id: 'clickType', name: 'Click Type', type: 'Dropdown', defaultValue: 'single', options: ['single', 'double'] },
    ], [flowOut, notFoundOut, { id: 'clickedName', name: 'Clicked Name', dataType: 'String' }]),
    define('action.browserType', 'Browser Type', 'Action', 'Types text into a browser element', [
      ...selectorProps('edit'),
      { id: 'text', name: 'Text', type: 'String', defaultValue: '' },
      { id: 'clearExisting', name: 'Clear Existing', type: 'Boolean', defaultValue: false },
    ], [flowOut, notFoundOut, { id: 'typedText', name: 'Typed Text', dataType: 'String' }]),
    define('action.browserWaitElement', 'Browser Wait Element', 'Action', 'Waits until a browser element is available', [
      ...selectorProps(),
      { id: 'storeInVariable', name: 'Store In Variable', type: 'String', defaultValue: '' },
    ], [flowOut, notFoundOut, { id: 'found', name: 'Found', dataType: 'Boolean' }]),
    ...
    define('action.listRunnableFlows', 'List Runnable Flows', 'Action', 'Builds a safe numbered menu of locally allowed flows', [
      { id: 'allowedFlowIds', name: 'Allowed Flow IDs', type: 'String', defaultValue: 'portfolio-*' },
      { id: 'includeHighRisk', name: 'Include High Risk', type: 'Boolean', defaultValue: false },
      { id: 'startNumber', name: 'Start Number', type: 'Integer', defaultValue: 10 },
      { id: 'storeMenuInVariable', name: 'Store Menu In Variable', type: 'String', defaultValue: 'runnableFlowsMenu' },
      { id: 'storeCatalogInVariable', name: 'Store Catalog In Variable', type: 'String', defaultValue: 'runnableFlowsCatalog' },
    ], [
      flowOut,
      { id: 'unavailable', name: 'Unavailable', dataType: 'Flow' },
      { id: 'menu', name: 'Menu', dataType: 'String' },
      { id: 'catalog', name: 'Catalog', dataType: 'String' },
      { id: 'count', name: 'Count', dataType: 'Number' },
    ]),
    define('action.runSavedFlow', 'Run Saved Flow', 'Action', 'Queues another saved flow through local validation and security policy', [
      { id: 'flowId', name: 'Flow ID', type: 'String', defaultValue: '{{requestedFlowId}}' },
      { id: 'source', name: 'Source', type: 'String', defaultValue: 'whatsapp' },
      { id: 'requestedBy', name: 'Requested By', type: 'String', defaultValue: '{{whatsappOwnerPhone}}' },
      { id: 'allowedFlowIds', name: 'Allowed Flow IDs', type: 'String', defaultValue: 'portfolio-*' },
      { id: 'allowHighRisk', name: 'Allow High Risk', type: 'Boolean', defaultValue: false },
      { id: 'storeResultInVariable', name: 'Store Result In Variable', type: 'String', defaultValue: 'runFlowResult' },
    ], [
      { id: 'queued', name: 'Queued', dataType: 'Flow' },
      { id: 'blocked', name: 'Blocked', dataType: 'Flow' },
      { id: 'needsConfiguration', name: 'Needs Configuration', dataType: 'Flow' },
      { id: 'requiresConfirmation', name: 'Requires Confirmation', dataType: 'Flow' },
      { id: 'notFound', name: 'Not Found', dataType: 'Flow' },
      { id: 'invalid', name: 'Invalid', dataType: 'Flow' },
      { id: 'unavailable', name: 'Unavailable', dataType: 'Flow' },
